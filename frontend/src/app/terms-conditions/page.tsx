...
import { 
  Scale, FileText, AlertTriangle, Shield, Link as LinkIcon, 
  CreditCard, User, ShoppingCart, Gavel, Mail, Phone, ArrowUpRight 
} from 'lucide-react';
    ...
    content: (
      <div className="grid md:grid-cols-2 gap-0 border border-gray-100">
        {[
          ...
          { icon: LinkIcon, title: 'Third-Party Links', body: 'Our website may contain links to third-party sites. We are not responsible for the content or privacy practices of these external sites.' },
