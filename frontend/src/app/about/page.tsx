                  ...
                  {!showFullStory ? (
                    <>
                      ...
                      <button
                        ...
                        className="mt-6 group inline-flex items-center gap-2 text-xs uppercase tracking-widest hover:text-gray-500 transition-all"
                      >
                        Read Full Story
                        <ChevronDown size={12} />
                      </button>
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="mt-6 group inline-flex items-center gap-2 text-xs uppercase tracking-widest text-black border-b border-black pb-0.5 hover:text-gray-500 transition-all"
                      >
                        Show Less
                        <ChevronUp size={12} />
                      </button>
