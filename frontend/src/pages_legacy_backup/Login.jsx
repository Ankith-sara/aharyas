...
const Login = () => {
  ...
  const handlePostLoginRedirect = useCallback(() => {
    const returnUrl = intendedPath || sessionStorage.getItem('returnUrl');
  ...
  usePageMeta({ 
    title: 'Login', description: 'Sign in to your Aharyas account to shop and track orders.' 
  });
  ...
  const handleForgotPasswordVerifyOtp = async (event) => {
    event.preventDefault();
    setOtpError('');
          ...
          <div className="min-h-full flex items-center justify-center px-6 py-12 sm:px-8 lg:px-12">
            <div className="w-full max-w-md">
              ...
              {isForgotPassword && !otpSent && (
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    disabled={otpLoading}
                    className="w-full mt-8 py-4 bg-black text-white font-light tracking-[0.2em] text-sm hover:bg-gray-800 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
                  >
              ...
              <div className="mt-8 text-center">
                <Link
                  to="/"
                  className="inline-flex items-center gap-1.5 text-xs text-gray-400 hover:text-black uppercase tracking-[0.2em] font-light transition-all duration-300 hover:-translate-x-0.5"
                >
