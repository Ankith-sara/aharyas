import { Phone, Mail, Clock, HelpCircle, Truck, RefreshCw, CreditCard, MapPin, ArrowUpRight } from 'lucide-react';
...
const Support = () => {
  usePageMeta({
    ...
    description: 'Get help with your Aharyas order — returns, exchanges, tracking, and more. Reach us by phone or email.',
  });
          ...
          <div className="relative bg-black px-10 py-12 overflow-hidden">
            ...
            <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              ...
              <a href="mailto:aharyasofficial@gmail.com" className="flex-shrink-0">
                <button className="group inline-flex items-center gap-3 border border-white/25 text-white px-7 py-3.5 text-xs font-medium uppercase tracking-widest hover:bg-white hover:text-black hover:border-white transition-all duration-300">
                  Get in Touch
