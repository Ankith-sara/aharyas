...
const PaymentBadge = ({ payment, paymentMethod }: { payment: boolean; paymentMethod: string }) => {
...
const StatusDropdown = ({ order, onStatusChange, onCODDeliveryConfirm }: { order: any; onStatusChange: (id: string, status: string) => void; onCODDeliveryConfirm: (id: string) => void }) => {
...
const CODDeliveryModal = ({ orderId, onConfirm, onCancel }: { orderId: string; onConfirm: (id: string) => void; onCancel: () => void }) => {
...
const OrderCard = ({ order, onStatusChange, onCODDeliveryConfirm }: { order: any; onStatusChange: (id: string, s: string) => void; onCODDeliveryConfirm: (id: string) => void }) => (
...
export default function OrdersPage() {
    ...
    try {
      ...
      if (data.success) {
        const normalized = data.orders
          .map((o: any) => ({ ...o, status: o.status === 'Order placed' ? 'Order Placed' : o.status }))
  ...
  const handleCODDeliveryConfirm = async (orderId: string) => {
