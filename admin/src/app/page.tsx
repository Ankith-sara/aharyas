...
export default function DashboardPage() {
  ...
  const [vercelAnalytics, setVercelAnalytics] = useState<any>(FAKE_VERCEL_ANALYTICS);
  ...
  const categoryBreakdown: any[] = analytics?.categoryBreakdown || [];
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="bg-white border border-gray-200 p-6 shadow-sm lg:col-span-6 space-y-6">
                  ...
                  <div>
                    ...
                    {(detailedReport?.highClickLowSales?.length ?? 0) > 0 ? (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="bg-white border border-gray-200 p-5 shadow-sm">
                      ...
                      <div className="h-64 relative">
                        <Line
                          data={{
                            labels: vercelAnalytics.byDay.map((d: any) => {
